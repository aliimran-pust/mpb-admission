            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <div class="card card-info">
                        ...
                        <!-- form start -->
                        <form method="post" action="{{ route('auth.permissions.store') }}" class="form-horizontal" role="form">
                            @csrf
                            ...
                            <div class="card-footer">
                                <button type="submit" name="btnPermission" class="btn btn-warning mb-2"><i class="fa fa-save"></i> Add </button>
